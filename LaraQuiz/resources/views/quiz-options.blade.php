...
<ol>
    <li class="option-item" data-correct="{{ $quiz->option_answer == 1 ? 'true' : 'false' }}">
        1. {{ $quiz->option_one }}
        @if($quiz->option_answer == 1)
            <svg class="icon green-tick" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="green" width="24" height="24"
                aria-hidden="true">
